      ...
      <section className="relative py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Join live coding competitions, solve challenging problems, and
            compete with developers worldwide. Experience the thrill of timed
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-300">
                Join live coding competitions and compete with others
              </p>
            </div>
                  ...
                  <div className="space-y-3 mb-6">
                    ...
                    <div className="flex items-center space-x-4 text-sm text-gray-400">
                      ...
                      <div className="flex items-center space-x-1">
                        ...
                        <span>
                          {Object.keys(event.submissions).length} submissions
                        </span>
                      </div>
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-400">
                Experience the thrill of live coding competitions with real-time
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400">
                Test your solutions with real JavaScript execution and
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400">
                Earn points based on correctness and speed. Faster solutions get
                higher scores.
              </p>
            </div>
          </div>
